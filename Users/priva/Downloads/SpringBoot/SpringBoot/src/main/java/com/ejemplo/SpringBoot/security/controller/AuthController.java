...
import com.ejemplo.SpringBoot.security.Mensaje;
...
import com.ejemplo.SpringBoot.service.RolService;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo (@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        usuario usua= new usuario(nuevoUsuario.getNombre(), nuevoUsuario.getNombreUsuario(), nuevoUsuario.getEmail(), 
         passwordEncoder.encode(nuevoUsuario.getPassword()));
        
        Set<rol> roles = new HashSet<>();
        roles.add(rolService.getbyRolNombre(RolEnumerado.ROLE_USER).get());
